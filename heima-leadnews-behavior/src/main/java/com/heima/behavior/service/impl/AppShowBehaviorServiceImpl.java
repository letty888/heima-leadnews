...
public class AppShowBehaviorServiceImpl implements AppShowBehaviorService {
    ...
    private final ApShowBehaviorMapper apShowBehaviorMapper;
    private final ApBehaviorEntryMapper apBehaviorEntryMapper;

    public AppShowBehaviorServiceImpl(ApShowBehaviorMapper apShowBehaviorMapper, ApBehaviorEntryMapper apBehaviorEntryMapper) {
        this.apShowBehaviorMapper = apShowBehaviorMapper;
        this.apBehaviorEntryMapper = apBehaviorEntryMapper;
    }
